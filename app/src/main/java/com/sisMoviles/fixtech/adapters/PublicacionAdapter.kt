...
class PublicacionAdapter (private val publicacionList:List<PublicacionModel>) : RecyclerView.Adapter<PublicacionViewHolder>(){
    ...
    override fun onBindViewHolder(holder: PublicacionViewHolder, position: Int) {
        holder.render(publicacionList[position])
    }
